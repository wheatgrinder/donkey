...
class TinyYolo():
        def __init__(self, NETWORK_IMAGE_WIDTH = 448, NETWORK_IMAGE_HEIGHT = 448):
...
#input_image_file= '/home/pi/d2/1.jpg'
#input_image_file= './dog.jpg'

# hardcoding path to yolo model \ graph for ncs
# 
# TODO will make this a input option
#tiny_yolo_graph_file= '/home/pi/d2/models/graph'
...
def display_objects_in_gui(source_image, filtered_objects):
    ...
    for obj_index in range(len(filtered_objects)):
        ...
        print('box at index ' + str(obj_index) + ':'+ filtered_objects[obj_index][0] + ' : %.2f:' % filtered_objects[obj_index][5] +'left: ' + str(box_left) + ', top: ' + str(box_top) + ', right: ' + str(box_right) + ', bottom: ' + str(box_bottom))  
        ...
        #print(filtered_objects[obj_index][0] + ' : %.2f' % filtered_objects[obj_index][5])



    window_name = 'TinyYolo (hit key to exit)'
    #cv2.imshow(window_name, display_image)
    cv2.imwrite('img_out.jpg', display_image)
